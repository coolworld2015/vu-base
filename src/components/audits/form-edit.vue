<template>
  ...
  <div v-else>
      ...
      <fieldset class="sender-data form-section-wrapper">
        ...
        <div class="form-section">
          ...
          <div class="form-group input-disabled">
            ...
            <input type="text" class="form-control" id="senderBirthPlace" placeholder="Місто народження, країна"
                   disabled>
            <div class="invalid-feedback">
        ...
        <div class="form-section">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" row="3" id="issueOrganization"
                      placeholder="Організація, що видала документ"></textarea>
            <div class="invalid-feedback">
    ...
    <div class="form-info">
      <p>Відправити платіж <span
        class="amount">{{((+amount).toFixed(2)).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1 ")}}</span> UAH</p>
